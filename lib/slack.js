...
export const ACTION_UPVOTE_HEADLINE = "upvote";
export const ACTION_DOWNVOTE_HEADLINE = "downvote";
export const ACTION_SELECT_HEADLINE = "select";
export const ACTION_UPVOTE_ART = "upvote";
export const ACTION_DOWNVOTE_ART = "downvote";
export const ACTION_SELECT_ART = "select";

const PROCESS_HEADLINE_VOTE_ENDTIME = "11:15";
const PROCESS_HEADLINE_SELECT_ENDTIME = "11:30";
const PROCESS_ART_VOTE_ENDTIME = "11:45";
const PROCESS_ART_SELECT_ENDTIME = "12:00";
...
export const postVoteHeadlineAction = async (headlines) => {
  ...
  blocks.push(mdBlock(`You have until ${PROCESS_HEADLINE_VOTE_ENDTIME}! \n _Its OK to vote multiple times_ \n See the <https://canvas-today.netlify.app/headlines|Voting Results Here>`));
  headlines.forEach((headline) => {
    blocks.push(textBlock(headline.headline));
    blocks.push(voteBlock(`${ACTION_UPVOTE_HEADLINE}${ACTION_SEPARATOR}${headline.id}`, `${ACTION_DOWNVOTE_HEADLINE}${ACTION_SEPARATOR}${headline.id}`));
  });
